...
public class PlayViewController {
    ...
    private void openMyTravelsWindow() {
        ...
        TableColumn<String, String> seatColumn = new TableColumn<>("Car-Seat");
        seatColumn.setCellValueFactory(data -> new SimpleStringProperty(data.getValue().split("\\|")[5]));
        ...
        ticketTable.getColumns().add(seatColumn);
